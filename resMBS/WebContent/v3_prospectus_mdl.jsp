			...
			<div class="right_col" role="main">
				<div class="row">
					...
					<div class="x_panel">
						<div class="x_title">
							<h2>
								Annual Prospectus Count (experiment trains on 2002-2006 prospectuses) <span id="cmp_header"></span>
							</h2>
						...
						<div class="x_content">
							...
							<div>
								<div class="x_title">
									<h2>
										Yearly Basis Prospectus Count Over Associated Topic (experiment trains on 2002-2006 prospectuses) <span
											id="cmp_header"></span>
									</h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i
...
<script src="js/v3prospectus.js"></script>
